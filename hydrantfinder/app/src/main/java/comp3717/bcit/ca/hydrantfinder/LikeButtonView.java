...
public class LikeButtonView extends FrameLayout implements View.OnClickListener {
    ...
    public void onClick(View v) {
        isChecked = !isChecked;
        ivHydrant.setImageResource(isChecked ? R.mipmap.ic_hydrant3 : R.mipmap.ic_hydrant);
        ...
        if (isChecked) {
            ivHydrant.animate().cancel();
            ivHydrant.setScaleX(0);
            ivHydrant.setScaleY(0);
            ...
            ObjectAnimator starScaleYAnimator = ObjectAnimator.ofFloat(ivHydrant, ImageView.SCALE_Y, 0.2f, 1f);
            starScaleYAnimator.setDuration(350);
            starScaleYAnimator.setStartDelay(250);
            starScaleYAnimator.setInterpolator(OVERSHOOT_INTERPOLATOR);

            ObjectAnimator starScaleXAnimator = ObjectAnimator.ofFloat(ivHydrant, ImageView.SCALE_X, 0.2f, 1f);
            ...
            animatorSet.addListener(new AnimatorListenerAdapter() {
                ...
                public void onAnimationCancel(Animator animation) {
                    ...
                    vCircle.setOuterCircleRadiusProgress(0);
                    vDotsView.setCurrentProgress(0);
                    ivHydrant.setScaleX(1);
                    ivHydrant.setScaleY(1);
                }
            });
    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ivHydrant.animate().scaleX(0.7f).scaleY(0.7f).setDuration(150).setInterpolator(DECCELERATE_INTERPOLATOR);
                setPressed(true);
                break;
            ...
            case MotionEvent.ACTION_UP:
                ivHydrant.animate().scaleX(1).scaleY(1).setInterpolator(DECCELERATE_INTERPOLATOR);
                if (isPressed()) {
                    performClick();
                    setPressed(false);
                }
